      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              ...
              <img alt="image" src="{{ auth()->user()->profile_picture ? Storage::url(auth()->user()->profile_picture) : asset('assets/img/avatar/avatar-1.png') }}" class="rounded-circle mr-1">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="{{ route('setting.profile.index') }}" class="dropdown-item has-icon">
